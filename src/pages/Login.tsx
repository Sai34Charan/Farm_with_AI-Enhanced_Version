...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Note: Actual authentication would require Supabase integration
  ...
  const handleSocialLogin = (provider: string) => {
    // Note: Social authentication would require Supabase integration
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary/30 to-accent/20 flex items-center justify-center px-4">
      <Card className="w-full max-w-md shadow-medium border-0 bg-card/95 backdrop-blur-sm">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            <Button
              ...
              variant="outline"
              className="w-full border-2 hover:border-primary hover:shadow-md transition-all duration-300 hover:scale-105"
            >
